                ...
                <div class="col-sm-10">
				  ...
				  ?>
				    <div class="input-group">
					  ...
					  <input id="input-keyword[<?php echo $lang_id; ?>][keyword]" type="text" name="keywords[<?php echo $lang_id; ?>][keyword]" value="<?php echo $keyword['keyword']; ?>"  placeholder="<?php echo $entry_keyword; ?>" class="form-control" /> 
					</div>
				  <?php } ?>
